...
class TestRedisClient:
    ...
    def test_get_customer_code_no_response(self, test_redis_client):
        ...
        with pytest.raises(RedisClientError, match=r'Customer codes not found for barcodes: 123, 456, 789'):
    ...
    def test_monitor_failed_lookups(self, test_redis_client):
        ...
        test_redis_client.logger.error.assert_called_with('Lookup failure rate is 40.0%')
