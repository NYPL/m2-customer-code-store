...
parser.add_argument("csvpath", metavar="CSVPATH", type=str, help="Path to the CSV")
parser.add_argument(
    "--batchsize",
    metavar="N",
    action="store",
...
class CsvWriter:
    def __init__(self):
        ...
        print(
            f"Loading {self.input_path} with batch-size {self.batch_size}, writing to {endpoint}"
        )
        if args.dryrun:
